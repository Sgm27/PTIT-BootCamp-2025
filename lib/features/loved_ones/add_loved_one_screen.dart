...
class _AddLovedOneScreenState extends State<AddLovedOneScreen> {
  ...
  // Hàm chuyển đến trang nhập OTP
  void _goToOtpPage() {
    // TODO: Thêm logic gọi API gửi OTP đến _phoneController.text ở đây
  ...
  void _confirmOtp() {
    // TODO: Thêm logic gọi API xác thực OTP ở đây
    print('Xác thực OTP: ${_otpController.text}');

    // Sau khi thành công, quay về màn hình trước với thông báo
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PageView(
        ...
        physics: const NeverScrollableScrollPhysics(), // Không cho người dùng tự lướt
        children: [
          _buildPhoneInputStep(), // Trang 0: Nhập SĐT
          _buildOtpInputStep(),   // Trang 1: Nhập OTP
        ],
      ),
    );
  }
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: _goToOtpPage, // Chuyển sang bước nhập OTP
      ...
      child: Column(
        ...
        children: [
          ...
          Align(
            ...
            child: TextButton(
              onPressed: () { /* TODO: Thêm logic gửi lại OTP */ },
          ...
          SizedBox(
            width: double.infinity,
            child: ElevatedButton(
              onPressed: _confirmOtp, // Xác nhận OTP và hoàn tất
              style: ElevatedButton.styleFrom(
                backgroundColor: AppColors.primary,
                foregroundColor: Colors.white,
                padding: const EdgeInsets.symmetric(vertical: 16),
  ...
  // Hàm trợ giúp để xây dựng các ô nhập liệu

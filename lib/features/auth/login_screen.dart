...
class _LoginScreenState extends State<LoginScreen> {
  ...
  // Biến cho checkbox "Ghi nhớ đăng nhập"
  ...
  // Widget cho form đăng nhập bằng số điện thoại
  ...
  // Widget cho form đăng nhập bằng email
  ...
  // Widget cho hàng "Ghi nhớ đăng nhập" và "Quên mật khẩu"
  ...
  // Helper để tạo InputDecoration cho các TextFormField
